...
### Environment ###
###################
from sandbox.crazyflie.src.gcg.envs.tfrecords.tfrecords_env import TfrecordsEnv
...
alg_params = {
    ...
    'kwargs': {
        ...
        'offpolicy': #[FOLDER PATH CONTAINING TFRECORDS WITH ROLLOUTS], 
        ...
        'total_steps': 10.e+6,  # corresponding to number of env.step(...) calls
